...
$lang = array_merge($lang, array(
	...
	'CONFIRM_QUESTION_EXPLAIN'	=> 'این سوالات از ارسال هرزنامه به سایت شما جلوگیری خواهد کرد',
	...
	'QUESTION_TEXT'				=> 'سوال',
	'QUESTION_TEXT_EXPLAIN'		=> 'سوالی که به کاربر مطرح میشود',

	'QA_ERROR_MSG'				=> 'لطفا همه فیلد ها را پر کنید و حداقل یک سوال را وارد کنید',
	'QA_LAST_QUESTION'			=> 'در حین فعال بودن این افزونه،نمیتوانید همه ی سوالات را حذف کنید',
