...
$lang = array_merge($lang, array(
	'ALREADY_DEFAULT_GROUP'		=> 'گروه انتخاب شده،گروه پیشفرض میباشد.',
	...
	'CANNOT_RESIGN_GROUP'		=> 'نمی توانید از این گروه استعفا دهید،فق طمی توانید از گروه های آزاد استعفا دهید.',
	'CHANGED_DEFAULT_GROUP'		=> 'گروه پیشفرض با موفقیت تغییر یافت.',

	'GROUP_AVATAR'						=> 'آواتار گروه',
	'GROUP_CHANGE_DEFAULT'				=> 'آیا از تغییر عضویتتان در گروه پیشفرض به “%s” مطمئن هستید ؟',
	'GROUP_CLOSED'						=> 'پسته شده',
	'GROUP_DESC'						=> 'توضیحات گروه',
	'GROUP_HIDDEN'						=> 'مخفی',
	'GROUP_INFORMATION'					=> 'اطلاعات گروه کاربری',
	'GROUP_IS_CLOSED'					=> 'این گروه،گروهی بسته میباشد و فقط با دعوت نامه مدیر گروه به کاربری ،آن کاربر میتواند در گروه عضو شود.',
	'GROUP_IS_FREE'						=> 'این گروه،گروهی باز میباشد و تمامی کاربران میتوانند عضو شوند.',
	...
	'REMOVE_SELECTED'		=> 'حذف مشخص شده ها',
