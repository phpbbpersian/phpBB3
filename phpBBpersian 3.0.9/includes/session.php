...
// Hejri Shamsi MOD : start
			if ($day !== false)
			{
				if ((basename($this->data['user_lang']) || basename($config['default_lang'])) == 'fa')
				{
					require_once ('jalali_true_format.php');
					return str_replace('||', $this->lang['datetime'][$day], jalali_true_format($date_cache[$format]['format_short'], $date_cache[$format]['lang'], $zone_offset, $gmepoch));
				}
				else
				{
		...
		{
			require_once ('jalali_true_format.php');
			return jalali_true_format($date_cache[$format]['format_long'], $date_cache[$format]['lang'], $zone_offset, $gmepoch);
		}
		else
		{
